  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-card rounded-lg border border-card-border p-8">
        ...
        {error && (
          <div className="mb-4 p-2 bg-deep-red/20 border border-deep-red rounded text-sm text-red-300">
            {error}
          </div>
        )}
        ...
        <button
          ...
          className="w-full py-3 bg-white text-gray-800 font-medium rounded-md hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 border border-gray-300"
        >
